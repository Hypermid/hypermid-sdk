...
exports.sendAtomicApproveAndSwap = sendAtomicApproveAndSwap;
 ...
 */
async function supportsAtomicBatch(provider, account, chainId) {
    try {
 ...
 */
async function sendAtomicApproveAndSwap(provider, p) {
    const calls = [
