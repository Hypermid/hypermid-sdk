...
exports.NI_CHAIN_BASE = exports.CHAIN_REGISTRY = void 0;
exports.resolveChain = resolveChain;
exports.toLifiChainId = toLifiChainId;
exports.toNIBlockchain = toNIBlockchain;
exports.toNumericId = toNumericId;
exports.isNIOnlyChain = isNIOnlyChain;
exports.supportsWalletDeposit = supportsWalletDeposit;
exports.getDryQuotePlaceholder = getDryQuotePlaceholder;
exports.getAllChains = getAllChains;
exports.getChainsByProvider = getChainsByProvider;
// ─── Constants ─────────────────────────────────────────────────────────────
...
const byNiBlockchain = new Map();
for (const entry of exports.CHAIN_REGISTRY) {
 ...
 */
function supportsWalletDeposit(input) {
    const entry = resolveChain(input);
 ...
 */
function getDryQuotePlaceholder(input) {
...
function getAllChains() {
    return [...exports.CHAIN_REGISTRY];
}
/**
 * Get chains filtered by provider.
 */
function getChainsByProvider(provider) {
    return exports.CHAIN_REGISTRY.filter((c) => c.providers.includes(provider));
}
/**
 * The Near Intents chain ID base constant (900_000_000).
 */
exports.NI_CHAIN_BASE = NI_BASE;
//# sourceMappingURL=chain-registry.js.map