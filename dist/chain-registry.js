 ...
 */
export function toLifiChainId(input) {
 ...
 */
export function toNIBlockchain(input) {
 ...
 */
export function supportsWalletDeposit(input) {
    const entry = resolveChain(input);
 ...
 */
export function getDryQuotePlaceholder(input) {
 ...
 */
export function getChainsByProvider(provider) {
